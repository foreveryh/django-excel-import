...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'APPReview.datetime'
        db.delete_column(u'city_viewer_appreview', 'datetime')

        # Adding field 'APPReview.create_at'
        db.add_column(u'city_viewer_appreview', 'create_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


        # Changing field 'APPReview.contact'
        db.alter_column(u'city_viewer_appreview', 'contact', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Adding field 'APPReview.datetime'
        db.add_column(u'city_viewer_appreview', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'APPReview.create_at'
        db.delete_column(u'city_viewer_appreview', 'create_at')


        # Changing field 'APPReview.contact'
        db.alter_column(u'city_viewer_appreview', 'contact', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'city_viewer.appreview': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "u'feedback'", 'max_length': '100', 'blank': 'True'}),
            'tracked': ('django.db.models.fields.CharField', [], {'default': "u'unfollow'", 'max_length': '255'})
        },
        u'city_viewer.area': {
