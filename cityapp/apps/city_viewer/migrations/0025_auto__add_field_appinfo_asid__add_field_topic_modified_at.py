...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APPInfo.asid'
        db.add_column(u'city_viewer_appinfo', 'asid',
                      self.gf('django.db.models.fields.CharField')(default=u'0', max_length=10),
                      keep_default=False)

        # Adding field 'Topic.modified_at'
        db.add_column(u'city_viewer_topic', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APPInfo.asid'
        db.delete_column(u'city_viewer_appinfo', 'asid')

        # Deleting field 'Topic.modified_at'
        db.delete_column(u'city_viewer_topic', 'modified_at')
