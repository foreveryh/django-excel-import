...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ASAccount'
        db.create_table(u'city_viewer_asaccount', (
        ...
        db.send_create_signal(u'city_viewer', ['ASAccount'])

        # Deleting field 'Picture.created_at'
        db.delete_column(u'city_viewer_picture', 'created_at')

        # Adding field 'Picture.modified_at'
        db.add_column(u'city_viewer_picture', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ASAccount'
        db.delete_table(u'city_viewer_asaccount')
        ...
        # Deleting field 'Picture.modified_at'
        db.delete_column(u'city_viewer_picture', 'modified_at')
