...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Topic.pic'
        db.alter_column(u'city_viewer_topic', 'pic', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Topic.pic'
        db.alter_column(u'city_viewer_topic', 'pic', self.gf('django.db.models.fields.FilePathField')(max_length=100))
    ...
    models = {
        ...
        u'city_viewer.topic': {
            ...
            'in_area': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['city_viewer.Area']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'pic': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
