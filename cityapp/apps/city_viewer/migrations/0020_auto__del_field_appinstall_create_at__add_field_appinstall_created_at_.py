...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'APPInstall.create_at'
        db.delete_column(u'city_viewer_appinstall', 'create_at')

        # Adding field 'APPInstall.created_at'
        db.add_column(u'city_viewer_appinstall', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Deleting field 'APPLike.create_at'
        db.delete_column(u'city_viewer_applike', 'create_at')

        # Adding field 'APPLike.created_at'
        db.add_column(u'city_viewer_applike', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Deleting field 'Area.create_at'
        db.delete_column(u'city_viewer_area', 'create_at')

        # Adding field 'Area.created_at'
        db.add_column(u'city_viewer_area', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Deleting field 'Picture.create_at'
        db.delete_column(u'city_viewer_picture', 'create_at')

        # Adding field 'Picture.created_at'
        db.add_column(u'city_viewer_picture', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'APPInstall.create_at'
        db.add_column(u'city_viewer_appinstall', 'create_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Deleting field 'APPInstall.created_at'
        db.delete_column(u'city_viewer_appinstall', 'created_at')

        # Adding field 'APPLike.create_at'
        db.add_column(u'city_viewer_applike', 'create_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Deleting field 'APPLike.created_at'
        db.delete_column(u'city_viewer_applike', 'created_at')

        # Adding field 'Area.create_at'
        db.add_column(u'city_viewer_area', 'create_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Deleting field 'Area.created_at'
        db.delete_column(u'city_viewer_area', 'created_at')

        # Adding field 'Picture.create_at'
        db.add_column(u'city_viewer_picture', 'create_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Deleting field 'Picture.created_at'
        db.delete_column(u'city_viewer_picture', 'created_at')
    ...
    models = {
        ...
        u'city_viewer.appreview': {
            ...
            'area': ('django.db.models.fields.related.ForeignKey', [], {'default': "u'1'", 'to': u"orm['city_viewer.Area']", 'blank': 'True'}),
