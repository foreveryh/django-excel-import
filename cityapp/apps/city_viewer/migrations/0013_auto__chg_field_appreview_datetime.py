...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'APPReview.datetime'
        db.alter_column(u'city_viewer_appreview', 'datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'APPReview.datetime'
        db.alter_column(u'city_viewer_appreview', 'datetime', self.gf('django.db.models.fields.DateTimeField')(default=0))
