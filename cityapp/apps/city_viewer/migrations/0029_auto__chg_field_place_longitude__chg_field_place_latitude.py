...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'city_viewer_place', 'longitude', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Place.latitude'
        db.alter_column(u'city_viewer_place', 'latitude', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Place.longitude'
        db.alter_column(u'city_viewer_place', 'longitude', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Place.latitude'
        db.alter_column(u'city_viewer_place', 'latitude', self.gf('django.db.models.fields.CharField')(max_length=20))
