...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'APPReview.created_at'
        db.add_column(u'city_viewer_appreview', 'created_at',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'APPReview.created_at'
        db.delete_column(u'city_viewer_appreview', 'created_at')
