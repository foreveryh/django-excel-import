...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Topic.pic'
        db.delete_column(u'city_viewer_topic', 'pic')

        # Adding field 'Topic.cover_pic'
        db.add_column(u'city_viewer_topic', 'cover_pic',
                      self.gf('django.db.models.fields.CharField')(default='default.jpg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Topic.pic'
        raise RuntimeError("Cannot reverse this migration. 'Topic.pic' and its values cannot be restored.")
        # Deleting field 'Topic.cover_pic'
        db.delete_column(u'city_viewer_topic', 'cover_pic')
