...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'APPDevice', fields ['identifier']
        db.create_index(u'city_viewer_appdevice', ['identifier'])


    def backwards(self, orm):
        # Removing index on 'APPDevice', fields ['identifier']
        db.delete_index(u'city_viewer_appdevice', ['identifier'])
