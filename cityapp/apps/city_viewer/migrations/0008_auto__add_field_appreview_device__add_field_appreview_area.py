...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APPReview.device'
        db.add_column(u'city_viewer_appreview', 'device',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['city_viewer.APPDevice'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'APPReview.area'
        db.add_column(u'city_viewer_appreview', 'area',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['city_viewer.Area']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APPReview.device'
        db.delete_column(u'city_viewer_appreview', 'device_id')
