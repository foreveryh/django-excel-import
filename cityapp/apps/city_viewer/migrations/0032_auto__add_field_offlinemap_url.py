...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OfflineMap.url'
        db.add_column(u'city_viewer_offlinemap', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OfflineMap.url'
        db.delete_column(u'city_viewer_offlinemap', 'url')
