...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.price'
        db.alter_column(u'city_viewer_place', 'price', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Place.price'
        db.alter_column(u'city_viewer_place', 'price', self.gf('django.db.models.fields.CharField')(max_length=100))
