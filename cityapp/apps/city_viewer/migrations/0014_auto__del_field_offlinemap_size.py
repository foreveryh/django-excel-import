...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OfflineMap.size'
        db.delete_column(u'city_viewer_offlinemap', 'size')


    def backwards(self, orm):
        # Adding field 'OfflineMap.size'
        db.add_column(u'city_viewer_offlinemap', 'size',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=50, unique=True),
                      keep_default=False)
