...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APPInfo.area'
        db.add_column(u'city_viewer_appinfo', 'area',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['city_viewer.Area'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)


        # Changing field 'OfflineMap.in_area'
        db.alter_column(u'city_viewer_offlinemap', 'in_area_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['city_viewer.Area'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting field 'APPInfo.area'
        db.delete_column(u'city_viewer_appinfo', 'area_id')


        # Changing field 'OfflineMap.in_area'
        db.alter_column(u'city_viewer_offlinemap', 'in_area_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['city_viewer.Area']))
    ...
    models = {
        ...
        u'city_viewer.appinfo': {
            ...
            'area': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['city_viewer.Area']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
        ...
        u'city_viewer.offlinemap': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_area': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['city_viewer.Area']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
