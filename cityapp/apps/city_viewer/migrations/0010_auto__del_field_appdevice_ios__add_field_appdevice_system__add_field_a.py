...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'APPDevice.ios'
        db.delete_column(u'city_viewer_appdevice', 'ios')

        # Adding field 'APPDevice.system'
        db.add_column(u'city_viewer_appdevice', 'system',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'APPDevice.platform'
        db.add_column(u'city_viewer_appdevice', 'platform',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'APPDevice.ios'
        db.add_column(u'city_viewer_appdevice', 'ios',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100),
                      keep_default=False)

        # Deleting field 'APPDevice.system'
        db.delete_column(u'city_viewer_appdevice', 'system')

        # Deleting field 'APPDevice.platform'
        db.delete_column(u'city_viewer_appdevice', 'platform')
