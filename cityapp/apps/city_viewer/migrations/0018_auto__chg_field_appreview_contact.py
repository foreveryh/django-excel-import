...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'city_viewer_appreview', 'contact', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'city_viewer.appreview': {
            ...
            'area': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['city_viewer.Area']", 'blank': 'True'}),
