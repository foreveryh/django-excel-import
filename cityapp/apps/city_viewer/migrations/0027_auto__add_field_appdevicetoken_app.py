...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APPDeviceToken.app'
        db.add_column(u'city_viewer_appdevicetoken', 'app',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['city_viewer.APPInfo']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APPDeviceToken.app'
        db.delete_column(u'city_viewer_appdevicetoken', 'app_id')
