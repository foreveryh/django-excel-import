...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OfflineMap.zoom'
        db.add_column(u'city_viewer_offlinemap', 'zoom',
                      self.gf('django.db.models.fields.CharField')(default=u'16', max_length=2),
                      keep_default=False)


        # Changing field 'OfflineMap.max_zoom'
        db.alter_column(u'city_viewer_offlinemap', 'max_zoom', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'OfflineMap.min_zoom'
        db.alter_column(u'city_viewer_offlinemap', 'min_zoom', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):
        # Deleting field 'OfflineMap.zoom'
        db.delete_column(u'city_viewer_offlinemap', 'zoom')


        # Changing field 'OfflineMap.max_zoom'
        db.alter_column(u'city_viewer_offlinemap', 'max_zoom', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'OfflineMap.min_zoom'
        db.alter_column(u'city_viewer_offlinemap', 'min_zoom', self.gf('django.db.models.fields.SmallIntegerField')())
