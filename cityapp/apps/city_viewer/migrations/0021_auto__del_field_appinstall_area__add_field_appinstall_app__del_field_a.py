...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'APPInstall.area'
        db.delete_column(u'city_viewer_appinstall', 'area_id')

        # Adding field 'APPInstall.app'
        db.add_column(u'city_viewer_appinstall', 'app',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['city_viewer.APPInfo']),
                      keep_default=False)

        # Deleting field 'APPLike.area'
        db.delete_column(u'city_viewer_applike', 'area_id')

        # Adding field 'APPLike.app'
        db.add_column(u'city_viewer_applike', 'app',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['city_viewer.APPInfo']),
                      keep_default=False)

        # Deleting field 'APPReview.area'
        db.delete_column(u'city_viewer_appreview', 'area_id')

        # Adding field 'APPReview.app'
        db.add_column(u'city_viewer_appreview', 'app',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=u'1', to=orm['city_viewer.APPInfo'], blank=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'APPInstall.area'
        raise RuntimeError("Cannot reverse this migration. 'APPInstall.area' and its values cannot be restored.")
        # Deleting field 'APPInstall.app'
        db.delete_column(u'city_viewer_appinstall', 'app_id')


        # User chose to not deal with backwards NULL issues for 'APPLike.area'
        raise RuntimeError("Cannot reverse this migration. 'APPLike.area' and its values cannot be restored.")
        # Deleting field 'APPLike.app'
        db.delete_column(u'city_viewer_applike', 'app_id')

        # Adding field 'APPReview.area'
        db.add_column(u'city_viewer_appreview', 'area',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=u'1', to=orm['city_viewer.Area'], blank=True),
                      keep_default=False)

        # Deleting field 'APPReview.app'
        db.delete_column(u'city_viewer_appreview', 'app_id')
    ...
    models = {
        ...
        u'city_viewer.appinfo': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latest_ver': ('django.db.models.fields.CharField', [], {'default': "u'1'", 'max_length': '3'}),
