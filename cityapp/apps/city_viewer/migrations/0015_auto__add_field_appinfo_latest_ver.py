...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APPInfo.latest_ver'
        db.add_column(u'city_viewer_appinfo', 'latest_ver',
                      self.gf('django.db.models.fields.CharField')(default=u'1.0', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APPInfo.latest_ver'
        db.delete_column(u'city_viewer_appinfo', 'latest_ver')
    ...
    models = {
        ...
        u'city_viewer.appinfo': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latest_ver': ('django.db.models.fields.CharField', [], {'default': "u'1.0'", 'max_length': '3'}),
