...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClickStat'
        db.create_table(u'city_viewer_clickstat', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('channel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['city_viewer.Channel'])),
            ('ip', self.gf('django.db.models.fields.IPAddressField')(default=u'0.0.0.0', max_length=15, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ))
        db.send_create_signal(u'city_viewer', ['ClickStat'])

        # Adding model 'Channel'
        db.create_table(u'city_viewer_channel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['city_viewer.APPInfo'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ))
        db.send_create_signal(u'city_viewer', ['Channel'])

        # Deleting field 'APPReview.ip_address'
        db.delete_column(u'city_viewer_appreview', 'ip_address')

        # Adding field 'APPReview.ip'
        db.add_column(u'city_viewer_appreview', 'ip',
                      self.gf('django.db.models.fields.IPAddressField')(default=u'0.0.0.0', max_length=15, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ClickStat'
        db.delete_table(u'city_viewer_clickstat')

        # Deleting model 'Channel'
        db.delete_table(u'city_viewer_channel')
        ...
        # Deleting field 'APPReview.ip'
        db.delete_column(u'city_viewer_appreview', 'ip')
