...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'APPDeviceToken'
        db.create_table(u'city_viewer_appdevicetoken', (
        ...
        db.send_create_signal(u'city_viewer', ['APPDeviceToken'])


    def backwards(self, orm):
        # Deleting model 'APPDeviceToken'
        db.delete_table(u'city_viewer_appdevicetoken')
