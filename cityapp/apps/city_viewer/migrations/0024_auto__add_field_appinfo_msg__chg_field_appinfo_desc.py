...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APPInfo.msg'
        db.add_column(u'city_viewer_appinfo', 'msg',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


        # Changing field 'APPInfo.desc'
        db.alter_column(u'city_viewer_appinfo', 'desc', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting field 'APPInfo.msg'
        db.delete_column(u'city_viewer_appinfo', 'msg')


        # Changing field 'APPInfo.desc'
        db.alter_column(u'city_viewer_appinfo', 'desc', self.gf('django.db.models.fields.TextField')(max_length=255))
