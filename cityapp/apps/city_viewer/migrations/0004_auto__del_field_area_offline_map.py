...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Area.offline_map'
        db.delete_column(u'city_viewer_area', 'offline_map')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Area.offline_map'
        raise RuntimeError("Cannot reverse this migration. 'Area.offline_map' and its values cannot be restored.")
