...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'city_viewer_appinstall', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['city_viewer.Area'])),
        ...
        db.send_create_signal(u'city_viewer', ['APPInstall'])

        # Adding model 'APPDevice'
        db.create_table(u'city_viewer_appdevice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('identifier', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ios', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
        ))
        db.send_create_signal(u'city_viewer', ['APPDevice'])

        # Adding model 'APPLike'
        db.create_table(u'city_viewer_applike', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['city_viewer.Area'])),
            ('device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['city_viewer.APPDevice'])),
            ('create_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ))
        db.send_create_signal(u'city_viewer', ['APPLike'])

        # Deleting field 'APPInfo.liked'
        db.delete_column(u'city_viewer_appinfo', 'liked')

        # Deleting field 'APPInfo.uninstall_count'
        db.delete_column(u'city_viewer_appinfo', 'uninstall_count')

        # Deleting field 'APPInfo.down_count'
        db.delete_column(u'city_viewer_appinfo', 'down_count')

        # Adding field 'OfflineMap.version'
        db.add_column(u'city_viewer_offlinemap', 'version',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'city_viewer_appinstall')

        # Deleting model 'APPDevice'
        db.delete_table(u'city_viewer_appdevice')

        # Deleting model 'APPLike'
        db.delete_table(u'city_viewer_applike')

        # Adding field 'APPInfo.liked'
        db.add_column(u'city_viewer_appinfo', 'liked',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=100),
                      keep_default=False)

        # Adding field 'APPInfo.uninstall_count'
        db.add_column(u'city_viewer_appinfo', 'uninstall_count',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'APPInfo.down_count'
        db.add_column(u'city_viewer_appinfo', 'down_count',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'OfflineMap.version'
        db.delete_column(u'city_viewer_offlinemap', 'version')
    ...
    models = {
        ...
        u'city_viewer.appdevice': {
            ...
            'ios': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'})
        },
