...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Area.cover_pic'
        db.delete_column(u'city_viewer_area', 'cover_pic')

        # Adding field 'Area.hotel_link'
        db.add_column(u'city_viewer_area', 'hotel_link',
                      self.gf('django.db.models.fields.URLField')(default='http://', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Area.cover_pic'
        db.add_column(u'city_viewer_area', 'cover_pic',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Deleting field 'Area.hotel_link'
        db.delete_column(u'city_viewer_area', 'hotel_link')
